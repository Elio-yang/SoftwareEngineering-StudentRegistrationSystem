    ...
    public void run() {
        ...
        do {
            try {
                ...
                // send request format    request_id: x1_x0    input_stream:xxx
                // x0=='1'  ---> client student auth
                //      x1=='0' ---> login request
                //                      get (id+passwd) -> query db for verify
                //      x1=='2' ---> registration
                //      x1=='3' ---> createSchedule
                //      x1=='4' ---> updateSchedule
                //      x1=='5' ---> deleteSchedule
                ...
                //      x1=='7' ---> submitSchedule
                //      x1=='8' ---> ViewGrades
                //      x1=='9' ---> submitDeleteSchedule
                //      x1=='a' ---> backStudRegistration
                request = dis.readUTF();
                String da[];
